...
public class PiLaActivityTracker implements ActionListener{
	    ...
	    private static Checkbox box1, box2, box3, box4, box5, box6, box7; 
	    private static JLabel label1, label2, label3, label4, label5, errorLabel; 
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(week == "week 1") {
				...
				label2 = new JLabel("Activities after Orientation:"); 
				...
				label3 = new JLabel("Goals for this week:"); 
			    label3.setBounds(10, 310, 200, 25);
				frame1.add(label3);
				
				if(optiont1.isSelected()){
				label4 = new JLabel("<html><ul>" +
				        ...
				        "</ul><html>");
				label4.setBounds(10, 330, 400, 150);
		...
		if(week == "week 2") {
			...
			if(optiont1.isSelected()) {
				...
				box1 = new Checkbox("Keep us posted via your team's slack channel on the schedule for your team meetings."); 
				box1.setBounds(10, 120, 500, 50);
				frame1.add(box1); 

				box2 = new Checkbox("Work on Template 1."); 
				box2.setBounds(10, 150, 200, 50);
				frame1.add(box2); 
				
				box3 = new Checkbox("Work on Template 2."); 
				box3.setBounds(10, 180, 500, 50);
				frame1.add(box3); 
		...
		if(week == "week 3") {
			...
			if(optiont1.isSelected()) {
				...
				box1 = new Checkbox("Work on Template 3a and 3b."); 
				box1.setBounds(10, 60, 500, 50);
				frame1.add(box1); 

				box2 = new Checkbox("Work on Template 4."); 
				box2.setBounds(10, 90, 550, 50);
				frame1.add(box2); 
				...
				box3 = new Checkbox("Provide feedback on the intern's draft of your profile (verbal & comments on template)."); 
				box3.setBounds(10, 120, 550, 50);
				frame1.add(box3); 
		...
		if(week == "week 4") {
			...
			if(optiont1.isSelected()) {
				...
				box3 = new Checkbox("Work on Template 5"); 
				box3.setBounds(10, 60, 500, 50);
				frame1.add(box3); 
				
				box4 = new Checkbox("Consult this Track 3 meeting Agenda Document for the specific tasks."); 
				box4.setBounds(10, 90, 550, 50);
				frame1.add(box4); 
				
				box5 = new Checkbox("Re-interviewing teachers to fill in any gaps in your story."); 
				box5.setBounds(10, 120, 500, 50);
				frame1.add(box5); 
				
				box6 = new Checkbox("Incorporate multimedia (pictures, videos, etc) from the teacher."); 
				box6.setBounds(10, 150, 500, 50);
				frame1.add(box6); 
				...
				box7 = new Checkbox("Fill out the google form to schedule time to meet with the Track 4 team."); 
				box7.setBounds(10, 180, 500, 50);
				frame1.add(box7); 
		...
		if(week == "week 7") {
			...
			if(optiont1.isSelected()) {
				...
				box3.setBounds(10, 60, 300, 50);
				frame1.add(box3); 
				
				label2 = new JLabel("Goals for this week:"); 
			    label2.setBounds(10, 120, 500, 25);
				frame1.add(label2);
				
				label3 = new JLabel("<html><ul>" +
				        "<li>Finalize showcase & profiles.</li>" + 
						"</ul><html>");
				label3.setBounds(10, 130, 400, 75);
				frame1.add(label3); 
			}
